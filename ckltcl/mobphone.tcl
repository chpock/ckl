...
namespace eval ::ckl {
  ...
  variable extract_mobile_phones_re {(?x)
		...
		(
		  (?:0[1-9]\d[\s\-]{0,3}\)?[\s\-]*\d[\s\-]*\d\d\d[\s\-]*\d\d\d)|
		  (?:0[1-9]\d[\s\-]{0,3}\)?[\s\-]*\d\d[\s\-]*\d\d[\s\-]*\d\d\d)|
		  (?:0[1-9]\d[\s\-]{0,3}\)?[\s\-]*\d\d[\s\-]*\d\d\d[\s\-]*\d\d)|
		  (?:0[1-9]\d[\s\-]{0,3}\)?[\s\-]*\d\d\d[\s\-]*\d[\s\-]*\d\d\d)|
		  (?:0[1-9]\d[\s\-]{0,3}\)?[\s\-]*\d\d\d[\s\-]*\d\d[\s\-]*\d\d)|
		  (?:0[1-9]\d[\s\-]{0,3}\)?[\s\-]*\d\d\d[\s\-]*\d\d\d[\s\-]*\d)|
		  (?:0[1-9]\d\(?\d\)?[\s\-]{0,3}\)?[\s\-]*\d[\s\-]*\d\d[\s\-]*\d\d\d)|
		  (?:0[1-9]\d\(?\d\)?[\s\-]{0,3}\)?[\s\-]*\d[\s\-]*\d\d\d[\s\-]*\d\d)|
		  (?:0[1-9]\d\(?\d\)?[\s\-]{0,3}\)?[\s\-]*\d\d[\s\-]*\d\d[\s\-]*\d\d)|
		  (?:0[1-9]\d\(?\d\)?[\s\-]{0,3}\)?[\s\-]*\d\d\d[\s\-]*\d\d\d)|
		  (?:0[1-9]\d[\s\-]?\d\d[\s\-]{0,3}\)?[\s\-]*\d[\s\-]*\d\d[\s\-]*\d\d)|
		  (?:0[1-9]\d[\s\-]?\d\d[\s\-]{0,3}\)?[\s\-]*\d\d[\s\-]*\d[\s\-]*\d\d)
		)
		(?!\d)}
